...
//--------def constructor--------//
AForm::AForm():_name(""), _signed(false), _sign_grade(0), _execute_grade(0){}

//--------copy constructor--------//
AForm::AForm(const AForm&  obj):_name(obj._name), _signed(obj._signed),_sign_grade(obj._sign_grade), _execute_grade(obj._execute_grade){
	*this = obj; 
}
